from transformers import Qwen2_5_VLConfig, Qwen2_5_VLForConditionalGeneration, GenerationConfig
import torch
from typing import Optional, Union


class QwenImageTextEncoderWithDecode(Qwen2_5_VLForConditionalGeneration):
    def __init__(self):
